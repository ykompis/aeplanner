...
# from: https://github.com/ethz-asl/mav_active_3d_planning
# mav_active_3d_planning/active_3d_planning_app_reconstruction/src/experiments/eval_data_node.py
...
class EvalData:
    ...
    def __init__(self):
        ...
        # Parse parameters
        self.ns_planner = rospy.get_param('~ns_planner', "/firefly")
        ...
        if self.evaluate:
            ...
            self.ns_voxblox = rospy.get_param('~ns_voxblox', "firefly/voxblox_node")
            ...
            self.cpu_time_srv = rospy.ServiceProxy(self.ns_planner + "/informative_planner/get_cpu_time", SetBool)
    ...
    def launch_simulation(self):
        ...
        # We assume this to be already running when this nodes starts
    ...
    def eval_callback(self, _):
        if self.evaluate:
            ...
            #    return
            self.eval_writer.writerow([map_name, time_ros, time_real, self.eval_n_pointclouds, 0.0])
    ...
    def eval_finish(self):
        # delete this parameter to ensure that the next simulation won't start with wrong param
        rospy.delete_param(self.ns_planner + "/performance_log_dir")
